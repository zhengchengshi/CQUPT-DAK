...
export default function messageHook() {
    ...
    useEffect(()=>{
        ...
        Taro.connectSocket({
            ...
            protocols: ['eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyLCJ1aWQiOiIzIn0.MblCZK3Istd4jHP-oYGmy0B7vplodB9lZpd2yrcMXFg']
        })
        .then(res=>{
            console.log(res)
        })
